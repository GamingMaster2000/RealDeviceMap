...
public class ConfigLoader {
    ...
    func getConfig<T>(type: ConfigType) -> T {
        ...
        case .infAutoQuest: return localConfig.application.process.infAutoQuest.value()
            ?? defaultConfig.application.process.infAutoQuest.value()!
        }
    }
    ...
    private func getEnvironmentValue<T>(type: ConfigType, value: String) -> T {
        ...
        case .infAutoQuest: return false as! T //ALLOW_INF_AUTO_QUEST
        }
    }
    ...
    enum ConfigType: String {
        ...
        case infAutoQuest = "ALLOW_INF_AUTO_QUEST"
    }
